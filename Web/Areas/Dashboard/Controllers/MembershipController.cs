...
namespace Tazeyab.Web.Areas.Dashboard.Controllers
{
    public partial class MembershipController : BaseAdminController
    {
        ...
        public virtual ActionResult Index()
        {
            ...
            model.GridMenu = new ColumnActionMenu(new ColumnActionMenu.ActionMenuItem(Common.Resource.General.Edit, "/Dashboard/Membership/Manage/#=Id#"),
                new ColumnActionMenu.ActionMenuItem(ColumnActionMenu.ItemType.ScriptCommand, Common.Resource.General.Delete, "deleteGridRow('/Dashboard/Membership/Delete/#=Id#')"));
            return View(model);
        }
