...
namespace Mn.NewsCms.Web.Models
{
    ...
    public class ChangePasswordModel
    {
        ...
        [System.Web.Mvc.Compare("NewPassword", ErrorMessage = "رمز عبور با تایید رمز عبور یکسان نیست")]
    ...
    public class RegisterModel
    {
        ...
        [DataType(DataType.Password)]
        [Display(Name = "تایید رمز عبور")]
        [System.Web.Mvc.Compare("Password", ErrorMessage = "پسورد و تکرارش با یکدیگر همخوانی ندارند")]
        public string ConfirmPassword { get; set; }
