...
namespace Mn.NewsCms.Web.Controllers
{
    public partial class PostController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.JsonResult SendComment()
        {
            return new T4MVC_System_Web_Mvc_JsonResult(Area, Name, ActionNames.SendComment);
        }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _PostItemList = "_PostItemList";
                public readonly string Index = "Index";
                public readonly string Page = "Page";
            }
            public readonly string _PostItemList = "~/Views/Post/_PostItemList.cshtml";
            public readonly string Index = "~/Views/Post/Index.cshtml";
            public readonly string Page = "~/Views/Post/Page.cshtml";
        }
    }
