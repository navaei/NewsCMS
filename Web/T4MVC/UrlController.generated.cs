...
namespace Tazeyab.Web.Controllers
{
    public partial class UrlController
    {
        ...
        public class ActionParamsClass_Index
        {
            ...
            public readonly string SocialNetwork = "SocialNetwork";
            public readonly string GotoLink = "GotoLink";
        }
    ...
    public partial class T4MVC_UrlController : Tazeyab.Web.Controllers.UrlController
    {
        ...
        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long Item, short SocialNetwork, string GotoLink);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(long Item, short SocialNetwork, string GotoLink)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "Item", Item);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "SocialNetwork", SocialNetwork);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "GotoLink", GotoLink);
            IndexOverride(callInfo, Item, SocialNetwork, GotoLink);
            return callInfo;
        }
