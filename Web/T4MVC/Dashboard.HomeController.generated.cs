...
namespace Mn.NewsCms.Web.Areas.Dashboard.Controllers
{
    public partial class HomeController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index___Copy = "~/Areas/Dashboard/Views/Home/Index - Copy.cshtml";
            public readonly string Index = "~/Areas/Dashboard/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : Mn.NewsCms.Web.Areas.Dashboard.Controllers.HomeController
    {
        ...
        [NonAction]
        partial void SearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string q);

        [NonAction]
        public override System.Web.Mvc.ActionResult Search(string q)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Search);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "q", q);
            SearchOverride(callInfo, q);
            return callInfo;
        }
