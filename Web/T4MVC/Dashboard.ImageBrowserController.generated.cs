...
namespace Tazeyab.Web.Areas.Dashboard.Controllers
{
    public partial class ImageBrowserController
    {
        ...
        protected ImageBrowserController(Dummy d) { }
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult UploadThumb()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.UploadThumb);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult CreateThumb()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CreateThumb);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ImageBrowserController Actions { get { return MVC.Dashboard.ImageBrowser; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Dashboard";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ImageBrowser";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ImageBrowser";
        ...
        {
            public readonly string UploadThumb = "UploadThumb";
            public readonly string CreateThumb = "CreateThumb";
        ...
        {
            public const string UploadThumb = "UploadThumb";
            public const string CreateThumb = "CreateThumb";
        ...
        static readonly ActionParamsClass_UploadThumb s_params_UploadThumb = new ActionParamsClass_UploadThumb();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_UploadThumb UploadThumbParams { get { return s_params_UploadThumb; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_UploadThumb
        {
            public readonly string path = "path";
            public readonly string file = "file";
        }
        static readonly ActionParamsClass_CreateThumb s_params_CreateThumb = new ActionParamsClass_CreateThumb();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_CreateThumb CreateThumbParams { get { return s_params_CreateThumb; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_CreateThumb
        {
            public readonly string path = "path";
    ...
    public partial class T4MVC_ImageBrowserController : Tazeyab.Web.Areas.Dashboard.Controllers.ImageBrowserController
    {
        ...
        [NonAction]
        partial void UploadThumbOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string path, System.Web.HttpPostedFileBase file);
        ...
        [NonAction]
        partial void CreateThumbOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string path, Kendo.Mvc.UI.FileBrowserEntry entry);

        [NonAction]
        public override System.Web.Mvc.ActionResult CreateThumb(string path, Kendo.Mvc.UI.FileBrowserEntry entry)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.CreateThumb);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "path", path);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "entry", entry);
            CreateThumbOverride(callInfo, path, entry);
            return callInfo;
        }
