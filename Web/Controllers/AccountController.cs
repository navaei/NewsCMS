...
namespace Mn.NewsCms.Web.Controllers
{
    ...
    public partial class AccountController : BaseController
    {
        ...
        public virtual ActionResult Login(string returnUrl)
        {
            ...
            var model = new LoginPage() { ReturnUrl = returnUrl, LoginModel = new LoginViewModel(), RegisterModel = new RegisterViewModel() };
            return View(model);
        }
        ...
        {
            return View("Login", new LoginPage() { UseRegister = true, LoginModel = new LoginViewModel(), RegisterModel = new RegisterViewModel() });
        }
        ...
        {
            var pmodel = new LoginPage() { UseRegister = true, LoginModel = new LoginViewModel(), RegisterModel = new RegisterViewModel() };
            if (ModelState.IsValid)
            {
        ...
        public virtual async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "بازیابی نام کاربری", "لطفا با کلیک روی لینک زیر پسورد خود را ریست کنید: <a href=\"" + callbackUrl + "\">لینک</a>");
                ViewBag.Link = callbackUrl;
                return View("ForgotPasswordConfirmation");
            }
        ...
        public virtual async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var result = await SignInManager.ExternalSignInAsyncLocal(loginInfo, isPersistent: false);
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(returnUrl);
