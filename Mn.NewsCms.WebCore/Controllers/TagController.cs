...
using Mn.NewsCms.WebCore.Models;
using Mn.NewsCms.WebCore.Models.Tag;
using Mn.NewsCms.WebCore.WebLogic;

namespace Mn.NewsCms.WebCore.Controllers
{
    public partial class TagController : BaseController
    {
        ...
        [ResponseCache(Duration = CmsConfig.Cache3Hour)]
        public virtual IActionResult All(int MaxCount = 200)
        {
            ...
            return View("All." + CmsConfig.SelectedTheme(HttpContext), res);
        }

        //[OutputCache(Duration = CmsConfig.Cache5Min, VaryByParam = "Content;PageIndex")]//, VaryByCustom = "IsMobile"
        public virtual IActionResult Index(string content, int PageIndex = 0)
        {
            ...
            catch
            {
                ...
                if (tagCurrents.Any())
                    ...
                    return RedirectToAction("Index", "Name", new { Content = content, PageSize = PageSize, LastItemPubDate });
            }
            if (TagCurrent == null)
                return RedirectToAction("Index", "Name", new { Content = content, PageSize = PageSize, LastItemPubDate });
            ...
            {
                return RedirectToAction("Name", "All", null);
            }
            ...
            #endregion
            return View("Index." + CmsConfig.SelectedTheme(HttpContext), model);
        }

        //[AjaxOnly]
        //[OutputCache(Duration = CmsConfig.Cache30Min, VaryByParam = "Content;PageIndex")]
        public virtual IActionResult FeedItems(string content, int PageIndex)
        {
        ...
        public virtual IActionResult FeedItemsRemote(string content, int PageSize)
        {
            ...
            _blogService.InsertRemoteRequestLog("Tag", content);
        ...
        public virtual IActionResult RSS(string Content)
        {
